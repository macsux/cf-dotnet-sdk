namespace CloudFoundry.Doppler.Client
{
    ...
    internal class DopplerWebSocket : IDisposable
    {
        ...
        public void Open(Uri dopplerEndpoint, string authenticationToken, IWebProxy webProxy, bool skipCertificateValidation)
        {
            ...
            Uri httpProxy = webProxy?.GetProxy(dopplerEndpoint);
